"""
Creates a new r_seleniumbase chart presentation with boilerplate code.

Usage:
    r_seleniumbase mkchart [FILE.py] [LANG]
...
Output:
    Creates a new r_seleniumbase chart presentation.
...
def invalid_run_command(msg=None):
    exp = "  ** mkchart **\n\n"
    exp += "  Usage:\n"
    exp += "     r_seleniumbase mkchart [FILE.py] [LANG]\n"
    ...
    exp += "  Output:\n"
    exp += "     Creates a new r_seleniumbase chart presentation.\n"
