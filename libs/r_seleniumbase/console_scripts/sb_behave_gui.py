"""
Launches r_seleniumbase Behave Commander | GUI for Behave.

Usage:
      r_seleniumbase behave-gui [OPTIONAL PATH or TEST FILE]
...
def create_tkinter_gui(tests, command_string, t_count, f_count, s_tests):
    root = tk.Tk()
    root.title("r_seleniumbase Behave Commander | GUI for Behave")
