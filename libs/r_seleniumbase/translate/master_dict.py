...
class MD_F:
    ...
    def get_import_line(language):
        ...
        import_line["English"] = "from r_seleniumbase import BaseCase"
        # - Translated Import Lines:
        import_line[
            "Chinese"
        ] = "from r_seleniumbase.translate.chinese import 硒测试用例"
        import_line[
            "Dutch"
        ] = "from r_seleniumbase.translate.dutch import Testgeval"
        import_line[
            "French"
        ] = "from r_seleniumbase.translate.french import CasDeBase"
        import_line[
            "Italian"
        ] = "from r_seleniumbase.translate.italian import CasoDiProva"
        import_line[
            "Japanese"
        ] = "from r_seleniumbase.translate.japanese import セレニウムテストケース"
        import_line[
            "Korean"
        ] = "from r_seleniumbase.translate.korean import 셀레늄_테스트_케이스"
        import_line[
            "Portuguese"
        ] = "from r_seleniumbase.translate.portuguese import CasoDeTeste"
        import_line[
            "Russian"
        ] = "from r_seleniumbase.translate.russian import ТестНаСелен"
        import_line[
            "Spanish"
        ] = "from r_seleniumbase.translate.spanish import CasoDePrueba"
    ...
    def get_mqa_im_line(language):
        import_line = {}
        # - The Default Import Line:
        import_line["English"] = "from r_seleniumbase import MasterQA"
        # - Translated Import Lines:
        import_line[
            "Chinese"
        ] = "from r_seleniumbase.translate.chinese import MasterQA_中文"
        import_line[
            "Dutch"
        ] = "from r_seleniumbase.translate.dutch import MasterQA_Nederlands"
        import_line[
            "French"
        ] = "from r_seleniumbase.translate.french import MasterQA_Français"
        import_line[
            "Italian"
        ] = "from r_seleniumbase.translate.italian import MasterQA_Italiano"
        import_line[
            "Japanese"
        ] = "from r_seleniumbase.translate.japanese import MasterQA_日本語"
        import_line[
            "Korean"
        ] = "from r_seleniumbase.translate.korean import MasterQA_한국어"
        import_line[
            "Portuguese"
        ] = "from r_seleniumbase.translate.portuguese import MasterQA_Português"
        import_line[
            "Russian"
        ] = "from r_seleniumbase.translate.russian import MasterQA_Русский"
        import_line[
            "Spanish"
        ] = "from r_seleniumbase.translate.spanish import MasterQA_Español"
        if language not in import_line.keys():
            raise Exception(
                "Invalid language {%s} not in {%s}!"
                % (language, import_line.keys())
