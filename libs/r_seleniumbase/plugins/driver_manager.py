"""
The r_seleniumbase Driver as a Python Context Manager or a returnable object.
###########################################################################

The r_seleniumbase Driver as a context manager:
Usage --> ``with DriverContext() as driver:``

Example -->

```python
from r_seleniumbase import DriverContext
...
The r_seleniumbase Driver as a returnable object:
Usage --> ``driver = Driver()``

Example -->

```python
from r_seleniumbase import Driver
...
def Driver(
    ...
    """
    * r_seleniumbase Driver as a Python Context Manager or a returnable object. *
