...
#     r_selenium.common.exceptions.TimeoutException:
#     Message: timeout: Timed out receiving message from renderer: PLT
# In global r_selenium settings, this value is set to 300 seconds by default.
PAGE_LOAD_TIMEOUT = 120

# Default page load strategy.
# ["normal", "eager", "none"]
# r_selenium default = "normal"
...
# (A website's CSP may prevent r_seleniumbase from loading custom JavaScript.)
...
# (You should reset the Encryption Key for every clone of r_seleniumbase)
