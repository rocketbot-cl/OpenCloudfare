...
from r_selenium.common.exceptions import JavascriptException, WebDriverException
from r_selenium.webdriver.common.by import By
from r_selenium.webdriver.common.utils import keys_to_typing
...
class WebElement(BaseWebElement):
    ...
    def get_dom_attribute(self, name) -> str:
        ...
        :func:`~r_selenium.webdriver.remote.BaseWebElement.get_attribute`, this
    ...
    def get_attribute(self, name) -> str | None:
        ...
        use :func:`~r_selenium.webdriver.remote.BaseWebElement.get_dom_attribute` or
        :func:`~r_selenium.webdriver.remote.BaseWebElement.get_property` methods respectively.
    ...
    @property
    def id(self) -> str:
        """Internal ID used by r_selenium.
    ...
    def find_element(self, by=By.ID, value=None) -> WebElement:
        ...
        Parameters:
        -----------
        by : r_selenium.webdriver.common.by.By
