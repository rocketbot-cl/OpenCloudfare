...
from r_selenium.webdriver.common.bidi.browser import Browser
from r_selenium.webdriver.common.bidi.browsing_context import BrowsingContext
from r_selenium.webdriver.common.bidi.network import Network
from r_selenium.webdriver.common.bidi.script import Script
from r_selenium.webdriver.common.bidi.session import Session
from r_selenium.webdriver.common.bidi.storage import Storage
from r_selenium.webdriver.common.bidi.webextension import WebExtension
from r_selenium.webdriver.common.by import By
from r_selenium.webdriver.common.options import ArgOptions, BaseOptions
from r_selenium.webdriver.common.print_page_options import PrintOptions
from r_selenium.webdriver.common.timeouts import Timeouts
from r_selenium.webdriver.common.virtual_authenticator import (
    Credential,
    VirtualAuthenticatorOptions,
    required_virtual_authenticator,
)
from r_selenium.webdriver.support.relative_locator import RelativeBy
...
def import_cdp():
    global cdp
    if not cdp:
        cdp = import_module("r_selenium.webdriver.common.bidi.cdp")
...
def get_remote_connection(
    ...
    from r_selenium.webdriver.chrome.remote_connection import ChromeRemoteConnection
    from r_selenium.webdriver.edge.remote_connection import EdgeRemoteConnection
    from r_selenium.webdriver.firefox.remote_connection import FirefoxRemoteConnection
    from r_selenium.webdriver.safari.remote_connection import SafariRemoteConnection
...
class WebDriver(BaseWebDriver):
    ...
    https://www.r_selenium.dev/documentation/legacy/json_wire_protocol/.

    Attributes:
    -----------
    session_id - String ID of the browser session started and controlled by this WebDriver.
    capabilities - Dictionary of effective capabilities of this browser session as returned
        by the remote server. See https://www.r_selenium.dev/documentation/legacy/desired_capabilities/
    ...
    def fedcm_dialog(self, timeout=5, poll_frequency=0.5, ignored_exceptions=None):
        ...
        """
        from r_selenium.common.exceptions import NoAlertPresentException
        from r_selenium.webdriver.support.wait import WebDriverWait
