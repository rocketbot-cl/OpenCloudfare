...
from r_selenium import __version__
...
class RemoteConnection:
    ...
    https://github.com/seleniumHQ/r_selenium/wiki/JsonWireProtocol
    """

    browser_name = None
    # Keep backward compatibility for AppiumConnection - https://github.com/seleniumHQ/r_selenium/issues/14694
    import os
    import socket
    ...
    extra_headers = None
    user_agent = f"r_selenium/{__version__} (python {system})"
